...
BOOST_AUTO_TEST_CASE(Simple)
{
	...
	fhicl::make_ParameterSet("event_builder_buffer_count: 10 event_builder_ranks: [1,2,3,4] tokens_used_per_table_percent: 50", ps);

	auto ct = artdaq::makeRoutingMasterPolicy("CapacityTest", ps);

	BOOST_REQUIRE_EQUAL(ct->GetEventBuilderCount(), 4);
	...
	ct->Reset();
	ct->AddEventBuilderToken(1, 1);
	ct->AddEventBuilderToken(3, 1);
	ct->AddEventBuilderToken(2, 1);
	ct->AddEventBuilderToken(4, 1);
	ct->AddEventBuilderToken(2, 1);
	...
	BOOST_REQUIRE_EQUAL(secondTable[5].sequence_id, 5);
	BOOST_REQUIRE_EQUAL(secondTable[6].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[6].sequence_id, 6);
	BOOST_REQUIRE_EQUAL(secondTable[7].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[7].sequence_id, 7);
	BOOST_REQUIRE_EQUAL(secondTable[8].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[8].sequence_id, 8);
	BOOST_REQUIRE_EQUAL(secondTable[9].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[9].sequence_id, 9);
	BOOST_REQUIRE_EQUAL(secondTable[10].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[10].sequence_id, 10);
	BOOST_REQUIRE_EQUAL(secondTable[11].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[11].sequence_id, 11);
	BOOST_REQUIRE_EQUAL(secondTable[12].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(secondTable[12].sequence_id, 12);

	ct->Reset();
	ct->AddEventBuilderToken(1, 0);
	...
	BOOST_REQUIRE_EQUAL(thirdTable[0].sequence_id, 0);
	BOOST_REQUIRE_EQUAL(thirdTable[1].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(thirdTable[1].sequence_id, 1);
	BOOST_REQUIRE_EQUAL(thirdTable[2].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(thirdTable[2].sequence_id, 2);
	BOOST_REQUIRE_EQUAL(thirdTable[3].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(thirdTable[3].sequence_id, 3);
	BOOST_REQUIRE_EQUAL(thirdTable[4].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(thirdTable[4].sequence_id, 4);
	BOOST_REQUIRE_EQUAL(thirdTable[5].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(thirdTable[5].sequence_id, 5);

	ct->AddEventBuilderToken(1, 2);
	ct->AddEventBuilderToken(2, 1);
	ct->AddEventBuilderToken(3, 1);
	ct->AddEventBuilderToken(4, 2);
	...
	BOOST_REQUIRE_EQUAL(fourthTable[0].sequence_id, 6);
	BOOST_REQUIRE_EQUAL(fourthTable[1].destination_rank, 1);
	BOOST_REQUIRE_EQUAL(fourthTable[1].sequence_id, 7);
	BOOST_REQUIRE_EQUAL(fourthTable[2].destination_rank, 2);
	BOOST_REQUIRE_EQUAL(fourthTable[2].sequence_id, 8);
	BOOST_REQUIRE_EQUAL(fourthTable[3].destination_rank, 3);
	BOOST_REQUIRE_EQUAL(fourthTable[3].sequence_id, 9);
	BOOST_REQUIRE_EQUAL(fourthTable[4].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(fourthTable[4].sequence_id, 10);
	BOOST_REQUIRE_EQUAL(fourthTable[5].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(fourthTable[5].sequence_id, 11);
	...
	BOOST_REQUIRE_EQUAL(fifthTable[0].sequence_id, 12);
	BOOST_REQUIRE_EQUAL(fifthTable[1].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(fifthTable[1].sequence_id, 13);
	BOOST_REQUIRE_EQUAL(fifthTable[2].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(fifthTable[2].sequence_id, 14);
	BOOST_REQUIRE_EQUAL(fifthTable[3].destination_rank, 4);
	BOOST_REQUIRE_EQUAL(fifthTable[3].sequence_id, 15);
