...
BOOST_AUTO_TEST_CASE(Simple)
{
	...
	fhicl::make_ParameterSet("event_builder_buffer_count: 2 event_builder_ranks: [1,2,3,4] nth_event: 5 target_event_builder: 3", ps);

	auto nth = artdaq::makeRoutingMasterPolicy("NthEvent", ps);

	BOOST_REQUIRE_EQUAL(nth->GetEventBuilderCount(), 4);
	...
	nth->Reset();
	nth->AddEventBuilderToken(1, 1);
	nth->AddEventBuilderToken(3, 1);
	nth->AddEventBuilderToken(2, 1);
	nth->AddEventBuilderToken(4, 1);
	nth->AddEventBuilderToken(2, 1);
	...
	nth->AddEventBuilderToken(1, 0);
	auto thirdTable = nth->GetCurrentTable();
	BOOST_REQUIRE_EQUAL(thirdTable.size(), 0);

	// Catching up to the extra token
	nth->AddEventBuilderToken(1, 2);
	nth->AddEventBuilderToken(3, 2);
	nth->AddEventBuilderToken(4, 2);
	...
	nth->AddEventBuilderToken(1, 10);
	nth->AddEventBuilderToken(2, 10);
	nth->AddEventBuilderToken(4, 10);
