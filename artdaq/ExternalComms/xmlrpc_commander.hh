...
private:
	...
	std::string send_command_(const std::string&, const std::string&, const std::string&, uint64_t);
	std::string send_command_(const std::string& command, uint64_t a, const std::vector<uint32_t>& b);
