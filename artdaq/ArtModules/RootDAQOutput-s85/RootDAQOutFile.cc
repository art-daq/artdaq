...
void art::RootDAQOutFile::selectProducts()
{
...
void art::RootDAQOutFile::beginInputFile(RootFileBlock const* rfb,
...
void art::RootDAQOutFile::incrementInputFileNumber()
{
	fp_.update<Granularity::InputFile>();
}

void art::RootDAQOutFile::respondToCloseInputFile(FileBlock const&)
{
...
void art::RootDAQOutFile::writeParentageRegistry()
{
...
void art::RootDAQOutFile::writeProcessConfigurationRegistry()
{
	// We don't do this yet; currently we're storing a slightly
	// bloated ProcessHistoryRegistry.
}

void art::RootDAQOutFile::writeProcessHistoryRegistry()
{
...
void art::RootDAQOutFile::writeProductDescriptionRegistry()
{
...
void art::RootDAQOutFile::writeProductDependencies()
{
...
void art::RootDAQOutFile::writeResults(ResultsPrincipal& resp)
{
	pResultsAux_ = &resp.aux();
	fillBranches<InResults>(resp, pResultsProductProvenanceVector_);
}

void art::RootDAQOutFile::writeTTrees()
{
