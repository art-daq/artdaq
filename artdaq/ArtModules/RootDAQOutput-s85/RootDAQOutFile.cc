...
void
art::RootDAQOutFile::writeOneEvent_EventPart(EventPrincipal const& e)
{
...
void
art::RootDAQOutFile::writeOneEvent_HistoryPart(EventPrincipal const& e)
{
  // History branch.
...
void
art::RootDAQOutFile::writeOneEvent_FileIndexPart(EventPrincipal const& e)
{
  // Add event to index
  {
...
void
art::RootDAQOutFile::writeSubRun_FileIndexPart(SubRunPrincipal const& sr)
{
  {
...
void
art::RootDAQOutFile::writeRun_FileIndexPart(RunPrincipal const& r)
{
  {
...
void
art::RootDAQOutFile::insertParents(std::set<ProductProvenance>& keptProvenance,
