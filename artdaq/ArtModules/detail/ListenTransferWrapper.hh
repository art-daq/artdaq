...
private:
	...
	ListenTransferWrapper(ListenTransferWrapper&&) = delete;
	ListenTransferWrapper& operator=(ListenTransferWrapper const&) = delete;
	ListenTransferWrapper& operator=(ListenTransferWrapper&&) = delete;
