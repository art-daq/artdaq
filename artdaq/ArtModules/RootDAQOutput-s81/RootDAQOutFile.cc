...
namespace art {
  ...
  bool
  RootDAQOutFile::OutputItem::operator<(OutputItem const& rh) const
  {
  ...
  bool
  RootDAQOutFile::shouldFastClone(bool const fastCloningSet,
...
art::RootDAQOutFile::createDatabaseTables()
{
  ...
  void
  RootDAQOutFile::setFileStatus(OutputFileStatus const ofs)
  {
  ...
  void
  RootDAQOutFile::beginInputFile(RootFileBlock const* rfb,
  ...
  void
  RootDAQOutFile::incrementInputFileNumber()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::respondToCloseInputFile(FileBlock const&)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  bool
  RootDAQOutFile::requestsToCloseFile()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeOne(EventPrincipal const& e)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeSubRun(SubRunPrincipal const& sr)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeRun(RunPrincipal const& r)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    pRunAux_ = &r.runAux();
  ...
  void
  RootDAQOutFile::writeParentageRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeFileFormatVersion()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeEventHistory()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeProcessConfigurationRegistry()
  {
  ...
  void
  RootDAQOutFile::writeProcessHistoryRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeFileCatalogMetadata(
  ...
  void
  RootDAQOutFile::writeParameterSetRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeProductDescriptionRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeProductDependencies()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::writeResults(ResultsPrincipal& resp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::setSubRunAuxiliaryRangeSetID(RangeSet const& ranges)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOutFile::setRunAuxiliaryRangeSetID(RangeSet const& ranges)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  template <BranchType BT>
  void
  RootDAQOutFile::fillBranches(Principal const& principal,
