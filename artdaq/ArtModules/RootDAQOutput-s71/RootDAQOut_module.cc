...
namespace art {
  ...
  void
  RootDAQOut::openFile(FileBlock const& fb)
  {
  ...
  void
  RootDAQOut::respondToOpenInputFile(FileBlock const& fb)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    ++inputFileCount_;
    if (!isFileOpen()) {
  ...
  void
  RootDAQOut::readResults(ResultsPrincipal const& resp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::respondToCloseInputFile(FileBlock const& fb)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    if (isFileOpen()) {
  ...
  void
  RootDAQOut::write(EventPrincipal& ep)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    if (dropAllEvents_) {
      return;
  ...
  void
  RootDAQOut::setSubRunAuxiliaryRangeSetID(RangeSet const& rs)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeSubRun(SubRunPrincipal& sr)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    if (dropAllSubRuns_) {
      return;
  ...
  void
  RootDAQOut::setRunAuxiliaryRangeSetID(RangeSet const& rs)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeRun(RunPrincipal& rp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeFileFormatVersion()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeProcessConfigurationRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeProcessHistoryRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeParameterSetRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    if (writeParameterSets_) {
  ...
  void
  RootDAQOut::writeProductDescriptionRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::writeParentageRegistry()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::doWriteFileCatalogMetadata(
    FileCatalogMetadata::collection_type const& md,
  ...
  void
  RootDAQOut::writeProductDependencies()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::doRegisterProducts(ProductDescriptions& producedProducts,
  ...
  void
  RootDAQOut::setFileStatus(OutputFileStatus const ofs)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    if (isFileOpen()) {
  ...
  void
  RootDAQOut::incrementInputFileNumber()
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
    if (isFileOpen()) {
  ...
  bool
  RootDAQOut::requestsToCloseFile() const
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::event(EventPrincipal const& ep)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::beginSubRun(SubRunPrincipal const& srp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::endSubRun(SubRunPrincipal const& srp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::beginRun(RunPrincipal const& rp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
  ...
  void
  RootDAQOut::endRun(RunPrincipal const& rp)
  {
    RecursiveMutexSentry sentry{mutex_, __func__};
